...
exports.downloader_youtube_video = (req, res) => {
  ...
  if (!video_url || !api_key) {
    return res.status(400).json({
      status: "Failed",
      code: 400,
      message: "Error, Video URL or API key parameters not found!"
    });
  }
  ...
  db.query('SELECT * FROM users WHERE api_key = ?', [api_key], (err, result) => {
    ...
    if (result.length > 0) {
          ...
          if (!data) {
            ...
            if (user.account_type !== "Premium" && user.account_type !== "Enterprise") {
              if (user.usage_limit <= 0) {
                return res.status(429).json("Batas penggunaan harian anda sudah habis. Coba lagi besok.");
              }
      ...
      return res.status(404).json({
        status: "Failed",
        code: 404,
        message: `Error, API key: ${api_key}, not found. If you don't have an API key, please register and get the key in the dashboard.`
      });
    }
  });
};
...
exports.downloader_youtube_play_video = (req, res) => {
  ...
  if (!video_title || !api_key) {
    return res.status(400).json({
      status: "Failed",
      code: 400,
      message: "Error, Video title or API key parameters not found!"
    });
  }
...
exports.downloader_twitter = (req, res) => {
  ...
  if (!target_url || !api_key) {
    return res.status(400).json({
      status: "Failed",
      code: 400,
      message: "Error, Target URL or API key parameters not found!"
    });
  }
...
exports.downloader_mediafire = (req, res) => {
  ...
  if (!file_url || !api_key) {
    return res.status(400).json({
      status: "Failed",
      code: 400,
      message: "Error, File URL or API key parameters not found!"
    });
  }
...
exports.downloader_soundcloud = (req, res) => {
  ...
  if (!audio_url || !api_key) {
    return res.status(400).json({
      status: "Failed",
      code: 400,
      message: "Error, Audio URL or API key parameters not found!"
    });
  }
...
exports.searcher_joox = (req, res) => {
  ...
  if (!audio_title || !api_key) {
    return res.status(400).json({
      status: "Failed",
      code: 400,
      message: "Error, Audio title or API key parameters not found!"
    });
  }
...
exports.searcher_lyrics = (req, res) => {
  ...
  if (!song_title || !api_key) {
    return res.status(400).json({
      status: "Failed",
      code: 400,
      message: "Error, Song title or API key parameters not found!"
    });
  }
...
exports.searcher_emoji = (req, res) => {
  ...
  if (!emoji_name || !api_key) {
    return res.status(400).json({
      status: "Failed",
      code: 400,
      message: "Error, Emoji name or API key parameters not found!"
    });
  }
...
exports.searcher_stack_overflow = (req, res) => {
  ...
  if (!post_title || !api_key) {
    return res.status(400).json({
      status: "Failed",
      code: 400,
      message: "Error, Post title or API key parameters not found!"
    });
  }
...
exports.searcher_sfilemobi = (req, res) => {
  ...
  if (!file_name || !api_key) {
    return res.status(400).json({
      status: "Failed",
      code: 400,
      message: "Error, File name or API key parameters not found!"
    });
  }
...
exports.searcher_happymod = (req, res) => {
  ...
  if (!app_name || !api_key) {
    return res.status(400).json({
      status: "Failed",
      code: 400,
      message: "Error, App name or API key parameters not found!"
    });
  }
...
exports.searcher_whatsapp_group = (req, res) => {
  ...
  if (!group_name || !api_key) {
    return res.status(400).json({
      status: "Failed",
      code: 400,
      message: "Error, Group name or API key parameters not found!"
    });
  }
...
exports.searcher_sticker = (req, res) => {
  ...
  if (!sticker_name || !api_key) {
    return res.status(400).json({
      status: "Failed",
      code: 400,
      message: "Error, Sticker name or API key parameters not found!"
    });
  }
...
exports.searcher_wallpaper = (req, res) => {
  ...
  if (!wallpaper_name || !api_key) {
    return res.status(400).json({
      status: "Failed",
      code: 400,
      message: "Error, Wallpaper name or API key parameters not found!"
    });
  }
...
exports.searcher_ringtone = (req, res) => {
  ...
  if (!ringtone_name || !api_key) {
    return res.status(400).json({
      status: "Failed",
      code: 400,
      message: "Error, Ringtone name or API key parameters not found!"
    });
  }
...
exports.searcher_pinterest = (req, res) => {
  ...
  if (!pint_search || !api_key) {
    return res.status(400).json({
      status: "Failed",
      code: 400,
      message: "Error, Pint search or API key parameters not found!"
    });
  }
...
exports.searcher_wikimedia = (req, res) => {
  ...
  if (!wiki_search || !api_key) {
    return res.status(400).json({
      status: "Failed",
      code: 400,
      message: "Error, Wiki Search or API key parameters not found!"
    });
  }
...
exports.searcher_wikipedia = (req, res) => {
  ...
  if (!wiki_search || !language || !api_key) {
    return res.status(400).json({
      status: "Failed",
      code: 400,
      message: "Error, Wiki search or Language or API key parameters not found!"
    });
  }
...
exports.searcher_google_it = (req, res) => {
  ...
  if (!gi_search || !api_key) {
    return res.status(400).json({
      status: "Failed",
      code: 400,
      message: "Error, GI search or API key parameters not found!"
    });
  }
...
exports.stalker_tiktok = (req, res) => {
  ...
  if (!username || !api_key) {
    return res.status(400).json({
      status: "Failed",
      code: 400,
      message: "Error, Username or API key parameters not found!"
    });
  }
...
exports.stalker_github_repo = (req, res) => {
  ...
  if (!username || !repo_name || !api_key) {
    return res.status(400).json({
      status: "Failed",
      code: 400,
      message: "Error, Username, Repo name or API key parameters not found!"
    });
  }
...
exports.stalker_npmjs_package = (req, res) => {
  ...
  if (!package_name || !api_key) {
    return res.status(400).json({
      status: "Failed",
      code: 400,
      message: "Error, Package name or API key parameters not found!"
    });
  }
...
exports.stalker_ip = (req, res) => {
  ...
  if (!ip_address || !api_key) {
    return res.status(400).json({
      status: "Failed",
      code: 400,
      message: "Error, IP address or API key parameters not found!"
    });
  }
...
exports.artificial_intelligence_openai_chatgpt_3 = (req, res) => {
  ...
  if (!question || !custom_question || !custom_answer || !api_key) {
    return res.status(400).json({
      status: "Failed",
      code: 400,
      message: "Error, Question, Custom question, Custom answer, or API key parameters not found!"
    });
  }
...
exports.artificial_intelligence_openai_chatgpt_35 = (req, res) => {
  ...
  db.query('SELECT * FROM users WHERE api_key = ?', [api_key], (err, result) => {
    ...
    if (result.length > 0) {
      ...
      if (user.account_type !== "Premium" && user.account_type !== "Enterprise") {
        return res.status(403).json("You do not have permission to access this feature. This feature is only available to Premium and Enterprise users.");
      } else {
...
exports.artificial_intelligence_openai_dalle_2 = (req, res) => {
  ...
  if (!text || !api_key) {
    return res.status(400).json({
      status: "Failed",
      code: 400,
      message: "Error, Text or API key parameters not found!"
    });
  }
...
exports.artificial_intelligence_chatty_ai = (req, res) => {
  ...
  if (!question || !api_key) {
    return res.status(400).json({
      status: "Failed",
      code: 400,
      message: "Error, Question or API key parameters not found!"
    });
  }
...
exports.artificial_intelligence_simsimi = (req, res) => {
  ...
  if (!question || !language || !api_key) {
    return res.status(400).json({
      status: "Failed",
      code: 400,
      message: "Error, Question, Language or API key parameters not found!"
    });
  }
...
const {
  ...
  db.query('SELECT * FROM users WHERE api_key = ?', [api_key], (err, result) => {
	...
	const response = await fetch(
		...
		{
			headers: { Authorization: `Bearer ${secret_key.hf}` },
			method: "POST",
...
huggingFace({"inputs": text}).then(async image => {
    res.set({ 'Content-Type': 'image/png' });
    res.send(image);
  })
            .catch(err => {
...
exports.artificial_intelligence_anime_filter = (req, res) => {
  ...
  if (!image_url || !api_key) {
    return res.status(400).json({
      status: "Failed",
      code: 400,
      message: "Error, Image URL or API key parameters not found!"
    });
  }
...
exports.canvas_emoji_mix = (req, res) => {
  ...
  if (!emoji || !emoji2 || !api_key) {
    return res.status(400).json({
      status: "Failed",
      code: 400,
      message: "Error, Emoji 1/2 or API key parameters not found!"
    });
  }
...
exports.canvas_welcome = (req, res) => {
  ...
  if (!member_name || !group_name || !member_count || !profile_picture_image_url || !background_image_url || !api_key) {
    return res.status(400).json({
      status: "Failed",
      code: 400,
      message: "Error, Member name, Group name, Member count, Profile picture image URL, Background image URL or API key parameters not found!"
    });
  }
...
exports.maker_darkness = (req, res) => {
  ...
  if (!image_url || !volume || !api_key) {
    return res.status(400).json({
      status: "Failed",
      code: 400,
      message: "Error, Image URL, Volume or API key parameters not found!"
    });
  }
...
exports.random_image_anime_sfw_akira = (req, res) => {
  ...
  if (!api_key) {
    return res.status(400).json({
      status: "Failed",
      code: 400,
      message: "Error, API key parameters not found!"
    });
  }
...
exports.check_nickname_game_free_fire = (req, res) => {
  ...
  if (!user_id || !api_key) {
    return res.status(400).json({
      status: "Failed",
      code: 400,
      message: "Error, User Id or API key parameters not found!"
    });
  }
...
exports.check_nickname_game_mobile_legends = (req, res) => {
  ...
  if (!user_id || !user_zone_id || !api_key) {
    return res.status(400).json({
      status: "Failed",
      code: 400,
      message: "Error, User Id, User zone Id or API key parameters not found!"
    });
  }
...
exports.url_shortener_tinyurl_with_alias = (req, res) => {
  ...
  if (!target_url || !alias || !api_key) {
    return res.status(400).json({
      status: "Failed",
      code: 400,
      message: "Error, Target URL, Alias or API key parameters not found!"
    });
  }
...
exports.converter_text_to_speech = (req, res) => {
  ...
  if (!text || !language || !api_key) {
    return res.status(400).json({
      status: "Failed",
      code: 400,
      message: "Error, Text, Language or API key parameters not found!"
    });
  }
...
exports.tools_get_temp_mail_inbox = (req, res) => {
  ...
  if (!id || !api_key) {
    return res.status(400).json({
      status: "Failed",
      code: 400,
      message: "Error, ID or API key parameters not found!"
    });
  }
...
exports.tools_screenshot_website = (req, res) => {
  ...
  if (!target_url || !device || !api_key) {
    return res.status(400).json({
      status: "Failed",
      code: 400,
      message: "Error, Target URL, Device or API key parameters not found!"
    });
  }
